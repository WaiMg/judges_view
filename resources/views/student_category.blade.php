...
@section('content')
    ...
    <div class="">
        ...
        <div class="grid grid-cols-4 gap-2 place-items-center text-white object-center ">
            <a class="box-border h-42 w-60  border-2 bg-red-600 bg-opacity-60 hover:bg-opacity-50 rounded-lg md:col-start-2 p-8 text-center shadow-2xl"
