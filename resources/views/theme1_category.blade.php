...
@section('content')
  ...
  <div class="container">
    <div class="grid grid-cols-10 "  style="padding:10px">
        ...
        <div class="col-2  text-center "style="border:2px solid white;border-radius:10px;background-color:red;width:300px;height:50px;color:white;padding:10px;">Theme-1 Category</div>
    </div>
